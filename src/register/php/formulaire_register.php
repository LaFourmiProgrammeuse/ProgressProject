...
$qprepare = $db->prepare('INSERT INTO users (username, password, password_length, mail, registered_date, last_ip_used) VALUES (:username, :password, :password_length, :mail, :registered_date, :user_ip)');

if($qprepare->execute(array('username' => $username, 'password' => $pwd_hashed, 'password_length' => $pwd_length, 'mail' => $email, 'registered_date' => $registered_date, 'user_ip' => $user_ip))){
