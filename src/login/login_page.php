			...
			<div id="body_content">
				<header>
					<div id="h_elements">
						...
						<div id="infb"><h3>If you are not registered yet, <a href="/register.php?redirection_path=<?php echo $redirection_path_b64; ?>" id="register_go" title="Sign up page">click here</a> to join us !</h3></div>
					</div>
				</header>
