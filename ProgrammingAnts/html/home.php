...
<html>
	...
	<head>
		...
		<body>
			<header>
				<span class="website_name"><h1><a href="home.html">ProgrammingAnts</a></h1></span>
				...
				<aside>
					<div id="side_menu">
						...
						<div class="bookmark">Current page</div>
						<div class="bookmark">Home</div>
						<div class="bookmark">Projects</div>
						<div class="bookmark">Forum</div>
